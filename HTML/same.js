 //SVG gauges script
var firstGauge = document.querySelector('.tcontainer .fcontainer .g-container:first-of-type .progress');
var firstTarget = parseInt(firstGauge.getAttribute('data-target'));
var firstGaugeReadout = document.querySelector('.tcontainer .fcontainer .g-container:first-of-type .percentage > .value');

var secondGauge = document.querySelector('.tcontainer .fcontainer .g-container:nth-of-type(2) .progress');
var secondTarget = parseInt(secondGauge.getAttribute('data-target'));
var secondGaugeReadout = document.querySelector('.tcontainer .fcontainer .g-container:nth-of-type(2) .percentage > .value');

var thirdGauge = document.querySelector('.tcontainer .scontainer .g-container:first-of-type .progress');
var thirdTarget = parseInt(thirdGauge.getAttribute('data-target'));
var thirdGaugeReadout = document.querySelector('.tcontainer .scontainer .g-container:first-of-type .percentage > .value');

var fourthGauge = document.querySelector('.tcontainer .scontainer .g-container:nth-of-type(2) .progress');
var fourthTarget = parseInt(fourthGauge.getAttribute('data-target'));
var fourthGaugeReadout = document.querySelector('.tcontainer .scontainer .g-container:nth-of-type(2) .percentage > .value');
